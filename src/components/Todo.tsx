...
export default function TodoList() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-white to-gray-400">
      <div className="w-full max-w-2xl p-8 rounded-lg shadow-2xl bg-blue-300 border-b-gray-200 transition-all hover:border-blue-300 hover:shadow-blue-400">
        <h1 className="text-4xl  font-bold mb-8 text-center text-neutral-800">
          Todo List
        </h1>
        ...
        <div className="flex items-center mb-6">
          ...
          <Button
            onClick={addTask}
            className="bg-teal-400 hover:bg-teal-600 text-white font-semibold py-2 px-4 rounded-lg transition-colors"
          >
            Add
          </Button>
        </div>
      ...
      <footer className=" text-2xl mt-8 text-neutral-800">
        Created By Ammad Qureshi
      </footer>
    </div>
  );
}
